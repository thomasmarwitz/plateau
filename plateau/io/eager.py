...
from plateau.io_components.write import raise_if_dataset_exists
...
def read_dataset_as_metapartitions(
    ...
    Returns
    -------
    List[plateau.io_components.metapartition.MetaPartition]
...
def commit_dataset(
    ...
    1. Add previously written partitions to this dataset
        ...
        :func:`~plateau.io.eager.write_single_partition` and :func:`~plateau.io.eager.create_empty_dataset_header`.
...
def write_single_partition(
    ...
    ----------
    data: Dict
        The input is defined according to :func:`~plateau.io_components.metapartition.parse_input_to_metapartition`

    Returns
    -------
    An empty :class:`~plateau.io_components.metapartition.MetaPartition` referencing the new files
    """
    if data is None:
...
def update_dataset_from_dataframes(
    ...
    Returns
    -------
    The dataset metadata object (:class:`~plateau.core.dataset.DatasetMetadata`).
